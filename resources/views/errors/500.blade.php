...
<body>
    <div class="floating-shapes">
        <i class="bi bi-bug-fill shape" style="font-size: 15rem;"></i>
        <i class="bi bi-gear-fill shape" style="font-size: 12rem;"></i>
        <i class="bi bi-tools shape" style="font-size: 18rem;"></i>
    </div>
    ...
    <div class="error-container">
        ...
        <p class="error-message">
            ...
            Our team has been notified and is working on fixing it.
        </p>
